...
MENU_ITEMS = [
    ...
    ("弹幕动画显示",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_danmu" + ".py"), 
    # Machine Learning
    ("图片数据采集器", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_training_set_collector" + ".py"), 
    ("人脸识别",  CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_face_recognition" + ".py"), 
    ("物体识别", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_object_recognition" + ".py"), 
    ("可可乐博标志识别", CATEGORY_ITEMS_DICT["ml"], MENU_ITEM_PARENT_PATH + "demo_coco_logo_recognition" + ".py"), 
    ...
    ("自动学习并追踪颜色", CATEGORY_ITEMS_DICT["vision"], MENU_ITEM_PARENT_PATH + "demo_learn_track_color" + ".py"), 
    ...
    ("录制视频", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_camera_record" + ".py"), 
    ("播放录制的视频", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_play_recorded_video" + ".py"),
    ("拼音语音识别", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_speech_pinyin_recognition" + ".py"),
