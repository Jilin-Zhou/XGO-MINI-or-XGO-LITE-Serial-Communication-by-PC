...
MENU_ITEMS = [
    ...
    ("Danmu (Subtitle) Demo",CATEGORY_ITEMS_DICT["basics"], MENU_ITEM_PARENT_PATH + "demo_danmu" + ".py"), 
    # Machine Learning
    ...
    ("Mandarin Reocgnition", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_speech_pinyin_recognition" + ".py"),
    # ("Speech Recog. (Record)", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_speech_record" + ".py"),
    # ("Speech Recog. (Use)", CATEGORY_ITEMS_DICT["audiovideo"], MENU_ITEM_PARENT_PATH + "demo_speech_recognition" + ".py")
]
