...
display_cjk_string(canvas, 10,10, "语音样本", font_size=1, color=(255,255,255))
display_cjk_string(canvas, 10,30, "收集程序", font_size=1, color=(255,255,255))
...
try:
    while _voice_record == True:
        ...
        for i in range(_voice_keyword_num):
            for j in range(_voice_model_num):
                ...
                display_cjk_string(canvas, 10,55, "记录进度：", font_size=1, color=(0,0,255))
                display_cjk_string(canvas, 15,77, "录制第" +str(i+1)+ "个语音片段第"+str(j+1)+ "遍", font_size=1, color=(0,0,0))
                display_cjk_string(canvas, 10,100, "按下按钮A进行录制", font_size=1, color=(0,0,255))
                display_cjk_string(canvas, 10,180, "记录状态：", font_size=1, color=(0,0,255))
                canvas.draw_rectangle(10,200, 230, 50, color=(0,0,0), thickness=1, fill=True)
                display_cjk_string(canvas, 10,200, "等待按下...", font_size=1, color=(20,20,20))
                ...
                while (_s_daemon.get_status() != 2):
                    if (_s_daemon.get_status() == 1):
                        ...
                        display_cjk_string(canvas, 10,200, "现在开始说！", font_size=2, color=(255,0,0))
                    ...
                    if (_s_daemon.get_status() == 5):
                        ...
                        display_cjk_string(canvas, 10,200, "准备中", font_size=2, color=(255,0,0))
                ...
                if (_s_daemon.get_status() == 2):
                    ...
                    display_cjk_string(canvas, 10,200, "记录成功.", font_size=2, color=(10,255,0))
        ...
        canvas.clear()
        display_cjk_string(canvas, 10,60, "语音样本", color=(10,255,0), font_size=2)
        display_cjk_string(canvas, 10,100, "正在记录中", color=(10,255,0), font_size=2)
        display_cjk_string(canvas, 10,140, "成功！", color=(10,255,0), font_size=2)
    ...
    display_cjk_string(canvas, 10,30, "语音样本", color=(255,0,0), font_size=2)
    display_cjk_string(canvas, 10,70, "正在记录中", color=(255,0,0), font_size=2)
    display_cjk_string(canvas, 10,110, "失败！", color=(255,0,0), font_size=2)


    display_cjk_string(canvas, 10,150, "原因：" + str(e), color=(255,0,0), font_size=2)
    lcd.display(canvas, oft=(_canvas_x,_canvas_y))
    _led_blue.value(0)
    _led_red.value(1)
