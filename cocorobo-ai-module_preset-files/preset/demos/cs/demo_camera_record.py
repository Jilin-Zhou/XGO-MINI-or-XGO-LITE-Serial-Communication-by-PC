...
while True:
    ...
    camera.draw_rectangle(0,0,224,25,color=(0,0,0),fill=True)
    lcd_draw_string(camera, 0,0, "按下A或B键开始或结束录制", color=(255,255,255), scale=1, mono_space=False)
    ...
    while button_count == True:
        ...
        display_cjk_string(camera, 0,0, "视频录制中...", font_size=1, color=(255,255,255))
        lcd.display(camera, oft=(8, 8))
        ...
        if button_count == False: 
            ...
            display_cjk_string(camera, 0,0, "视频录制结束", font_size=1, color=(255,255,255))
            lcd.display(camera, oft=(8, 8))
