...
while True:
    ...
    display_cjk_string(img, 10, 10, "正在播放: doraemon.wav", font_size=1, color=(255,255,255))
    lcd.display(img)
    ...
    if (_audio_play_state) == True:
        ...
        print("Done.")
        display_cjk_string(img, 10, 10, "正在播放: doraemon.wav", font_size=1, color=(100,100,100))
        display_cjk_string(img, 10, 35, "播放结束", font_size=1, color=(255,0,0))
        lcd.display(img)
        break
