...
for i in range(80):
    ...
    display_cjk_string(img, 0,0,"请将想要追踪的颜色", font_size=1, color=(255,255,255))
    display_cjk_string(img, 0,25,"放置于屏幕中的方框中:", font_size=1, color=(255,255,255))
...
for i in range(80):
    ...
    for blob in img.find_blobs([threshold], pixels_threshold=100, area_threshold=100, merge=True, margin=10):
        ...
        img.draw_rectangle(r)
        img.draw_rectangle(0,0, 240, 50, fill=True, color=(0,0,0))
        display_cjk_string(img, 0,0,"正在学习中...", font_size=1, color=(255,255,255))
        display_cjk_string(img, 0,25,"请保持颜色放置在镜头内", font_size=1, color=(255,255,255))
        lcd.display(img, oft=(8,8))
    	# img_len = v.record(img)
