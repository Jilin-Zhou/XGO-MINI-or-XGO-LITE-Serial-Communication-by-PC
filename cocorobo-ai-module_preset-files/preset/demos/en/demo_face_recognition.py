...
while(True):
    ...
    display_cjk_string(img, 0, 0, "Face Detection Demo", font_size=1, color=(255,255,255))
    display_cjk_string(img, 0, 150, "Num. of faces: " + str(face_count), font_size=1, color=(255,255,255))
