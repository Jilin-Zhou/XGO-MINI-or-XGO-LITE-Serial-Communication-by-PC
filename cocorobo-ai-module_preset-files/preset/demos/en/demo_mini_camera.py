...
def take_picture(button_count):
    ...
    img_raw.save("/sd/user/camera/cocoshot"+ str(button_count) +".jpg", quality=90)
    img_captured.draw_rectangle(0,0,200,20,fill=True,color=(0,0,0))
    display_cjk_string(img_captured, 0, 0, "saved as cocoshot_"+str(button_count)+".jpg", font_size=1, color=(255,255,255))
