...
try:
    ...
    display_cjk_string(canvas, 3,0, "Load Error", color=(255,0,0), font_size=2)
    display_cjk_string(canvas, 3,110, "This recognition demo will ", color=(160,160,160), font_size=1)
    display_cjk_string(canvas, 3,130, "recognize 3 different clips,", color=(160,160,160), font_size=1)
    display_cjk_string(canvas, 3,150, "but you must record samples", color=(160,160,160), font_size=1)
    display_cjk_string(canvas, 3,170, "by using the program", color=(160,160,160), font_size=1)
    display_cjk_string(canvas, 3,190, "from demo menu first:", color=(160,160,160), font_size=1)
    display_cjk_string(canvas, 3,210, "Speech Recogntion (Record)", color=(0,220,220), font_size=1)
...
while True:
    ...
    display_cjk_string(canvas, 3,0, "Press Button A", color=(255,255,255), font_size=1)
    display_cjk_string(canvas, 3,25, "To Start Recognition", color=(255,255,255), font_size=1)
    ...
    if _gp_side_a.value() == 1:
        ...
        display_cjk_string(canvas, 3, 0, "Speak Now!", color=(0,255,0), font_size=1)
        ...
        if (_s_ret > 0):
            ...
            display_cjk_string(canvas, 3,0, "Nothing", color=(255,0,0), font_size=1)
            display_cjk_string(canvas, 3,25, "Recognized", color=(255,0,0), font_size=1)
