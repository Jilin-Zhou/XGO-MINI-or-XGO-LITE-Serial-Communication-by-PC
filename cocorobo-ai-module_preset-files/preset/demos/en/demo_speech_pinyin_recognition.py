...
while True:
    ...
    lcd_draw_string(canvas, 20, 120-10, "Result will shown above", color=(100,100,100), scale=1, mono_space=False)
    ...
    lcd_draw_string(canvas,5, 150, "Please say the following:", color=(255,255,255), scale=1, mono_space=False)
